...
window.PaperSections.data.sectionheight = parseInt(windowHeight);

view.setViewSize(window.outerWidth, window.PaperSections.data.sectionheight * window.PaperSections.data.sectionscount);

console.log(window.PaperSections.data.sectionheight * window.PaperSections.data.sectionscount);
$('.section-b').height(windowHeight);
